        ...
        <motion.div
          ...
          <div className="bg-gray-800 rounded-lg flex flex-col justify-center py-8 px-6 lg:mr-2 animate">
            ...
            <motion.p initial= {{opacity: 0, y: 20}}
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }} className="text-white mb-4">
              Weather-Now is a simple weather platform that aims to streamline weather reports and simplify weather information. It is user friendly and has weather dashboard, statistics, calender, and even map functions integrated.
            </motion.p>
            <motion.div initial= {{opacity: 0, y: 20}}
              whileInView={{opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
