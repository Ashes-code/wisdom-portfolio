            ...
            <ul className="lg:hidden flex flex-col justify-between items-center bg-[#1F2937] text-gray-400 absolute top-20 left-0 w-full py-5 shadow-lg z-10">
              <li className="text-lg font-semibold hover:text-white transition-all tracking-widest">
                <motion.a initial={{opacity: 0, y: 30}}
                  ...
                  viewport={{ once: true }} href="#about">About</motion.a>
              </li>
              <li className="text-lg font-semibold hover:text-white transition-all tracking-widest ">
                <motion.a initial={{opacity: 0, y: 30}}
                  whileInView={{opacity: 1, y: 0}}
                  ...
                  viewport={{ once: true }} href="#projects">Projects</motion.a>
              </li>
              <li className="text-lg font-semibold hover:text-white transition-all tracking-widest ">
                <motion.a initial={{opacity: 0, y: 30}}
                  whileInView={{opacity: 1, y: 0}}
                  ...
                  viewport={{ once: true }} href="#contact">Contact</motion.a>
              </li>
            </ul>
          )}
